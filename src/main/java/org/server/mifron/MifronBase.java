...
abstract class MifronBase extends JavaPlugin {
   ...
   protected final EconomyPriceTable economyPriceTable = new EconomyPriceTable(this);
   protected final QuestService questService = new QuestService(this);
   protected final ChunkProtectionFeature chunkProtectionFeature = new ChunkProtectionFeature(this);
   protected final ProtectionService protectionService = new ProtectionService(this, this.chunkProtectionFeature);
   protected final ServerPortalFeature serverPortalFeature = new ServerPortalFeature(this);
   protected final SurvivalDimensionFeature survivalDimensionFeature = new SurvivalDimensionFeature(this);
   protected final CompassFeature compassFeature = new CompassFeature(this);
   protected final WorldRulesFeature worldRulesFeature = new WorldRulesFeature(this);
   protected final UtilityItemsFeature utilityItemsFeature = new UtilityItemsFeature(this);
   protected final AdvancedAnvilFeature advancedAnvilFeature = new AdvancedAnvilFeature(this);
   protected BedrockUiFeature bedrockUiFeature;
   protected final TextDisplayFeature textDisplayFeature = new TextDisplayFeature(this);
   protected final AuctionFeature auctionFeature = new AuctionFeature(this, this.economyPriceTable);
   protected final BuildWorldManager buildWorldManager = new BuildWorldManager(this);
   protected final StructureManager structureManager = new StructureManager(this);
   protected final ProposalManager proposalManager = new ProposalManager(this);
   protected final QuestProposalFeature questProposalFeature = new QuestProposalFeature(this, this.proposalManager);
   protected final QuestProgressListener questProgressListener = new QuestProgressListener(this, this.questService);
   protected final ProtectedInteractionListener protectedInteractionListener = new ProtectedInteractionListener(this, this.protectionService);
   protected final FfaManager ffaManager = new FfaManager(this);
   protected final FfaListener ffaListener = new FfaListener(this, this.ffaManager);
   protected final SlotMachineManager slotMachineManager = new SlotMachineManager(this);
   protected final AthleticManager athleticManager = new AthleticManager(this);
   protected final MinoruBridgeFeature minoruBridgeFeature = new MinoruBridgeFeature(this);
   protected final ShopBlockFeature shopBlockFeature = new ShopBlockFeature(this);

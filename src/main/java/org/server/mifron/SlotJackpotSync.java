...
final class SlotJackpotSync {
   ...
   static boolean beginSpin(Mifron var0, Player var1) {
   ...
   static boolean enableMode(Mifron var0, Player var1) {
      String var2 = "players." + var1.getUniqueId();
   ...
   static void unlockAndClear(Mifron var0, Player var1, String var2) {

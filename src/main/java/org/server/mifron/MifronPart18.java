...
abstract class MifronPart18 extends MifronPart17x1 {
   ...
   protected void handleAthleticCommand(Player player, String[] args) {
      if (!this.hasPermission(player, "mifron.reward.grant")) return;
   ...
   protected void handleMinigameCommand(Player player, String[] args) {
      ...
      switch (args[1].toLowerCase(Locale.ROOT)) {
         ...
         case "unlock" -> {
            ...
            if (amount <= 0 || !this.withdrawEmeralds(player.getUniqueId(), amount)) { player.sendMessage("\u00a7c\u7d0d\u54c1\u3067\u304d\u307e\u305b\u3093\u3002"); return; }
            ...
            this.saveData();
            player.sendMessage("\u00a7a" + key + " \u306b " + this.formatNumber(amount) + "MP \u7d0d\u54c1\u3057\u307e\u3057\u305f\u3002");
         }
   ...
   protected void handleEmeraldCommand(CommandSender sender, String[] args) {
      ...
      if (args.length >= 4 && List.of("give", "grant", "add").contains(args[1].toLowerCase(Locale.ROOT))) {
         ...
         if (target.isOnline() && target.getPlayer() != null) target.getPlayer().sendMessage("\u00a7a\u7ba1\u7406\u8005\u304b\u3089 " + this.formatNumber(amount) + "MP \u304c\u914d\u5e03\u3055\u308c\u307e\u3057\u305f\u3002");
         return;
      }
